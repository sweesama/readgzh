...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    tags: ["新增", "计费"],
    items: [
      "定价页新增「企业版」区块，三档明码标价，团队共享积分池、不按人头收费",
      "新增「企业采购」页面，填写公司信息即可提交需求，我们 1 个工作日内回复报价与付款信息",
      "支持银行对公转账、支付宝、微信付款，可开具增值税电子普通发票（信息技术服务*技术服务费）",
      "常见问题补充发票说明：个人订阅走 Stripe 只有电子收据，需要发票请走企业通道",
      "「邀请好友」活动延期至 2026 年 11 月 19 日",
    ],
  },
  {
    date: "2026-07-10",
    title: "修复了一些问题，文章图片可以正常显示了",
    tags: ["修复"],
    items: [
      "修复了部分场景下文章只有文字、看不到图片的问题",
      "现在网页浏览和 AI 助手读取文章时，都能正常看到原文配图",
    ],
  },
  {
    date: "2026-07-07",
