...
const advantages = [
  ...
  { icon: TrendingDown, title: "更省 Token", desc: "清理空标签、嵌套容器与无效字符，输出比原始微信 HTML 精简得多，降低 AI 调用成本" },
  ...
  { icon: Database, title: "共享缓存", desc: "已抓取文章进入共享缓存，命中缓存时不扣积分，多个 Agent 共享同一份数据" },
];
  ...
  <div id="feature-advantages" className="container mx-auto px-4 py-16">
    <div className="max-w-5xl mx-auto">
      ...
      <p className="text-center text-muted-foreground mb-10">
        不只是简单转发，我们对输出内容做了大量精简处理，让 AI 读起来更省 Token、更少干扰
      </p>
