import { Sparkles, Eraser, TrendingDown, ShieldOff, Image, FileText, Cloud, Images, Split, Brain } from "lucide-react";
...
const advantages = [
  ...
  { icon: Split, title: "长文智能分页", desc: "超长文章自动按段落边界拆分为 ~40KB 分块，通过 ?part=N 逐段读取，避免 AI 截断" },
  { icon: Brain, title: "AI 智能摘要", desc: "Pro 用户可用 ?mode=summary 获取 300-500 字结构化摘要，Agent 无需读全文即可获取核心情报" },
  { icon: FileText, title: "纯 HTML 直出", desc: "无需 JavaScript 渲染，AI 爬虫直接获取完整内容，兼容所有 AI 平台" },
  { icon: Cloud, title: "云端零安装", desc: "无需本地部署、无需浏览器插件，手机电脑随时可用" },
];
