...
const faqs = [
  ...
  {
    q: "使用 ReadGZH 需要注册吗？",
    a: "不注册也能用！网页版和 API 均支持匿名访问，每天免费 10 次。注册后每天可领取 50 积分，Pro 会员每天自动获得 2,000 积分。",
  },
  {
    q: "转换后的文章会保存多久？",
  ...
  {
    q: "有使用次数限制吗？",
    a: "匿名用户每天 10 次（按 IP 限制），注册用户每天 50 积分（需手动领取），Pro 会员每天 2,000 积分（自动重置）。简单文章消耗 1 积分，复杂文章（≥5张图）消耗 2 积分。已缓存文章的读取免费。",
  },
  {
    q: "支持哪些类型的微信文章？",
