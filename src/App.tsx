...
import { WechatMarkdownPage, CompareWechatPage, WechatNotesPage } from "./pages/guides/PracticalGuides";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/guides/wechat-article-notes" element={<WechatNotesPage />} />
